...
namespace WasmClientEFCore.Db.Migrations
{
    ...
    [Migration("20200417120010_AddCustomerNameSeedDb")]
    partial class AddCustomerNameSeedDb
    {
            ...
            modelBuilder.Entity("WasmClientEFCore.Db.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2020, 4, 17, 12, 0, 9, 632, DateTimeKind.Utc).AddTicks(6061)
                        });
                });
