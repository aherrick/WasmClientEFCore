...
namespace WasmClientEFCore.Db.Migrations
{
    ...
    [Migration("20200417120639_AddWeightOrderDetail")]
    partial class AddWeightOrderDetail
    {
            ...
            modelBuilder.Entity("WasmClientEFCore.Db.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2020, 4, 17, 12, 6, 39, 512, DateTimeKind.Utc).AddTicks(7972)
                        });
                });
